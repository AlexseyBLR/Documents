...
/**
 * <p>Java class for DocPersonGroup complex type.
 * 
 ...
 *         &lt;element name="docPerson" type="{http://document.dha.gov.by}DocPerson" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "DocPersonGroup", namespace = "http://document.dha.gov.by", propOrder = {
    "attr",
    "docPerson"
})
public class DocPersonGroup {

    @XmlElement(namespace = "http://document.dha.gov.by", required = true)
    protected List<Attr> attr;
    @XmlElement(namespace = "http://document.dha.gov.by", required = true)
    protected List<DocPerson> docPerson;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the docPerson property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDocPerson().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DocPerson> getDocPerson() {
        if (docPerson == null) {
            docPerson = new ArrayList<DocPerson>();
        }
        return this.docPerson;
    }
