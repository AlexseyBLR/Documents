...
/**
 * <p>Java class for DocSign complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="docPersonGroup" type="{http://document.dha.gov.by}DocPersonGroup" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "DocSign", namespace = "http://document.dha.gov.by", propOrder = {
    "docPersonGroup"
})
public class DocSign {

    @XmlElement(namespace = "http://document.dha.gov.by", required = true)
    protected List<DocPersonGroup> docPersonGroup;
    ...
    /**
     * Gets the value of the docPersonGroup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the docPersonGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDocPersonGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DocPersonGroup> getDocPersonGroup() {
        if (docPersonGroup == null) {
            docPersonGroup = new ArrayList<DocPersonGroup>();
        }
        return this.docPersonGroup;
    }
