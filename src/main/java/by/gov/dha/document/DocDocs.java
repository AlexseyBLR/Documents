...
/**
 * <p>Java class for DocDocs complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="refDoc" type="{http://document.dha.gov.by}RefDoc" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "DocDocs", namespace = "http://document.dha.gov.by", propOrder = {
    "refDoc"
})
public class DocDocs {

    @XmlElement(namespace = "http://document.dha.gov.by", required = true)
    protected List<RefDoc> refDoc;
     ...
     * This is why there is not a <CODE>set</CODE> method for the refDoc property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRefDoc().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RefDoc> getRefDoc() {
        if (refDoc == null) {
            refDoc = new ArrayList<RefDoc>();
        }
        return this.refDoc;
    }
