...
/**
 * <p>Java class for DocOrgs complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="refOrg" type="{http://document.dha.gov.by}RefOrg" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "DocOrgs", namespace = "http://document.dha.gov.by", propOrder = {
    "refOrg"
})
public class DocOrgs {

    @XmlElement(namespace = "http://document.dha.gov.by", required = true)
    protected List<RefOrg> refOrg;
    ...
    /**
     * Gets the value of the refOrg property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the refOrg property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRefOrg().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RefOrg> getRefOrg() {
        if (refOrg == null) {
            refOrg = new ArrayList<RefOrg>();
        }
        return this.refOrg;
    }
